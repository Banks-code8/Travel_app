     ...
     bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
      ...
      p-6 lg:2px-20 lg:py-10 ">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16 md:cold-20 text-white">peopleJoined</p>
        ...
        overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit.
             Sint doloribus praesentium doloremque debitis soluta autem cumque reiciendis 
             quos repellat repudiandae earum hic impedit esse aspernatur ipsa,
              saepe explicabo est alias.
          </p>
          <Image 
          src="/quote.svg"
          alt="camp-2"
